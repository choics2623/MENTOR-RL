...
class RayPPOTrainer(object):
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            validation_accuracy = self._calculate_validation_accuracy(test_batch, output_texts)
            reward_extra_infos_dict["acc"].extend(validation_accuracy)
    ...
    def _calculate_validation_accuracy(self, test_batch, output_texts):
        """Calculate accuracy for validation samples"""
        from verl.trainer.ppo.metric_utils import _extract_model_answer, _check_answer_correctness
        ...
        for i in range(len(output_texts)):
            try:
                ...
                model_answer = _extract_model_answer(output_texts[i])
                ...
                # If processing fails, mark as incorrect
                accuracies.append(0)
    ...
    def fit(self):
        ...
        # Initialize cumulative invalid tool tracking
        self.cumulative_invalid_tools = 0
        self.cumulative_total_responses = 0
