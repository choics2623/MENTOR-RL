...
MAX_RESPONSE_LENGTH=YOUR_MAX_RESPONSE_LENGTH  # e.g., 12000
MAX_NUM_BATCHED_TOKENS=YOUR_MAX_NUM_BATCHED_TOKENS  # e.g., 64000, 128000
USE_MENTOR=True
...
ABLATION_EXP_ID=MENTOR  # Options: SPARSE, ABLATION2, ABLATION3, MENTOR, ABLATION4
ROLLOUT_N=YOUR_ROLLOUT_N  # e.g., 5, 10
ROLLOUT_TP=YOUR_ROLLOUT_TP  # e.g., 2
ROLLOUT_GPU_UTIL=YOUR_ROLLOUT_GPU_UTIL  # e.g., 0.8
MAX_TURNS=YOUR_MAX_TURNS  # e.g., 5
SEARCH_URL=YOUR_SEARCH_URL  # e.g., http://0.0.0.0:7777
SANDBOX_URL=YOUR_SANDBOX_URL  # e.g., http://0.0.0.0:2623
PROJECT_NAME=MENTOR-qwen2.5

NNODES=YOUR_NNODES  # e.g., 1
N_GPUS_PER_NODE=YOUR_N_GPUS_PER_NODE  # e.g., 8
SAVE_FREQ=YOUR_SAVE_FREQ  # e.g., 10, 15, 80
TEST_FREQ=YOUR_TEST_FREQ  # e.g., 4, 10, 15
TOTAL_EPOCHS=YOUR_TOTAL_EPOCHS  # e.g., 2, 5

WANDB_API_KEY=YOUR_WANDB_API_KEY_HERE


TRAIN_FILES="['/path/to/your/train.parquet']"  # Update with your training data path
TEST_FILES="['/path/to/your/test.parquet']"  # Update with your test data path
...
EXPERIMENT_NAME=qwen2.5-7b-$ABLATION_EXP_ID-1Node-8GPUs-bs-$TRAIN_BATCH_SIZE-mini-$PPO_MINI_BATCH_SIZE-rollout-$ROLLOUT_N
SAVE_PATH=$SAVE_BASE_DIR/qwen2.5-7b/$EXPERIMENT_NAME
