...
ABLATION_EXP_ID=SPARSE  # Options: SPARSE, ABLATION2, ABLATION3, MENTOR, ABLATION4
...
EXPERIMENT_NAME=ABLATION-FINAL-8B-$ABLATION_EXP_ID-1Node-8GPUs-$MODEL_NAME-bs-$TRAIN_BATCH_SIZE-mini-$PPO_MINI_BATCH_SIZE-rollout-$ROLLOUT_N
